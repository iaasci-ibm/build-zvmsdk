...
Group: System/tools
Autoreq: no
Requires: python >= 3.6, python3-netaddr >= 0.7.19, python3-requests >= 2.22.0, python3-routes >= 2.4.1, python3-webob >= 1.8.5, python3-jsonschema >= 3.2.0, python3-six >= 1.14.0, zthin >= 3.1.2, python3-jinja2 >= 2.11
